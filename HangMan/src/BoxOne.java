...
public class BoxOne{
    ...
    /**
     * the Pop up box that comes up when Player 1 Puzzle is hit. Additionally
     * the String is converted into all capital letters
     */
    public void makeBoxOne() {
        input = new String();
        outputString = new String();

        while (true) {
            input = JOptionPane.showInputDialog("Player 1 Enter a Puzzle");
